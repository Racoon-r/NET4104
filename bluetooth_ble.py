...
class bluetooth_ble(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "BLE Implementation", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("BLE Implementation")
        ...
        self.settings = Qt.QSettings("GNU Radio", "bluetooth_ble")
...
def main(top_block_cls=bluetooth_ble, options=None):
